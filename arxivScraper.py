...
while start < end:
    ...
    if start == 0:
        ...
        logging.info('Total results for this query: {}'.format(feed.feed.opensearch_totalresults))
    logging.info('Items per page for this query: {}'.format(feed.feed.opensearch_itemsperpage))
    logging.info('Start index for this query: {}'.format(feed.feed.opensearch_startindex))
